...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'requirement' => [
            'required' => 'ご用件が選択されていません'
        ],
        'kana' => [
            'regex' => 'ふりがなはひらがなで入力してください',
        ],
        // メール形式チェックしなくても勝手に弾いてくれる
        // 'email' => [
        //     'email' => 'E-MAILはメールの形式で入力してください',
        // ],
        'tel-0' => [
            'digits_between:2,4' => '電話番号は半角数字で入力してください'
        ],
        'tel-1' => [
            'digits_between:2,4' => '電話番号は半角数字で入力してください'
        ],
